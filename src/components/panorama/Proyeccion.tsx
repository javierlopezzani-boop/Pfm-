        ...
        <table className="w-full min-w-[480px] text-xs">
          <thead>
            <tr className="text-left text-gray-400">
              <th className="px-1 py-1 font-normal">Mes</th>
              <th className="px-1 py-1 text-right font-normal">Cuotas</th>
              <th className="px-1 py-1 text-right font-normal">Gastos</th>
              <th className="px-1 py-1 text-right font-normal">Saldo mes</th>
              <th className="px-1 py-1 text-right font-normal">Acumulado</th>
            </tr>
          </thead>
          <tbody>
            {meses.map((m) => (
              <tr
                ...
                className={`border-t border-gray-50 ${
                  m.mes === cruce ? "bg-brand-50 font-semibold" : ""
                }`}
              >
                ...
                <td className="px-1 py-1.5 text-right text-gray-600">
                  {clp(m.cuotas)}
                </td>
                <td className="px-1 py-1.5 text-right text-gray-600">
                  {clp(m.gastosFijos)}
